...
function reportWindowSize() {
  if (mobileCheck || window.innerWidth < 800) {
    panel.remove();
    document.querySelector(".bodycase").style.marginTop = "10px";
    document.querySelector(".bodycase").style.marginRight = "0px";
    console.log("hi")
  }

  if (window.innerWidth > 800) {
    page.append(panel)
    document.querySelector(".bodycase").style.marginTop = "72px";
    document.querySelector(".bodycase").style.marginRight = "5vw";
  }
}
reportWindowSize();